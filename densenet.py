...
@LastEditTime: 2019-02-19 18:37:22
...
def load_data():
    ...
    #                                    vertical_flip=True)
    train_datagen = ImageDataGenerator(preprocessing_function=lambda x: (
...
def model_build():
    ...
    model = DenseNet(IN_SHAPE, depth=40, nb_dense_block=5,
                     growth_rate=6, bottleneck=True, reduction=0.5, weights=None, classes=1)
